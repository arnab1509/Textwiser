...
def Text_to_speech():
    ...
    Button(w, text='SAVE', font='Verdana 12 bold', command=threading.Thread(target=Save).start, bg='#77dad6').place(
        x=100, y=180)
...
def Audio_Video_to_text():
    ...
    Button(w, text="Get Text", font="Verdana 10 bold", command=threading.Thread(target=Get_text).start).place(x=30,
                                                                                                              y=180)
